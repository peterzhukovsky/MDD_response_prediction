% AHBA test RnoR maps only left side
clear
...
c3vs1_tstat=tstatCAN(1:180); c3vs1_tstat=tstatEMB1(1:180); c3vs1_tstat=tstatEMB2(1:180);
...
%% TRD genes
% from Fabri 2019: GRIK4, BDNF, SLC6A4, and KCNK2 from  https://www.nature.com/articles/s41397-019-0067-3/tables/1 (wigmore and mcintosh): 'ACADSB–HMX3';'MON1B';'SRPK1–SLC26A8';'CNTN1'; from https://www.nature.com/articles/tp2016171#Sec11 23andMe: the rest 
...
%from  Fabbri 2021 https://www.nature.com/articles/s41380-021-01062-9#Sec19: 
Howard={'RNA5SP142';'RNY4P16';'RPL21P41';'NRSN2';'FSHB';'GRIP1';'ARL14EP';'C17orf70';'RNA5SP99';'UBBP1';'CDKAL1';'AP001891,1';'RP11-324F11,1';'CTC-458G6,2';'LRBA';'PRDM11';'DPP6';'SPSB1';'LOC105375639';'ATP6V0E1';'IGBP1P5';'TBX19';'PDXK';'RP11-863P13,4';'SS18L1';'MCM5';'CTD-2349P21,1';'PWRN4';'NAALADL2';'RP11-421E17,4';'SCFD1';'MAP3K7';'CHRM3';'AC144521,1';'RNU7-147P';'snoU13';'PRG3'};
...
Howard=UKB_minus; Howard=UKB_plus;
...
colors={'r'}; hold off
permutations=250;
load('C:\Users\peter\Documents\CANBIND\reports\AHBA\perm_weights_subcort5.mat', 'geneweights1_perm', 'probes_with_weights');
clear tmp tmp2
for i=1:length(Howard)
...
p_auc=sum(Rauc>auc)/permutations-1
